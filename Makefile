...
MAIN = main.c
INCLUDE = telaInicial.c jogador.c inimigos.c chefes.c joystick.c arma.c projetil.c background.c fases.c configuracoes.c
...
OBJS = telaInicial.o jogador.o inimigos.o chefes.o joystick.o arma.o projetil.o background.o fases.o configuracoes.o $(MAIN:.c=.o)
