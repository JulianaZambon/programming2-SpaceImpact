...
int main()
{
    ...
    jogador_1->sprite = al_load_bitmap("assets/jogador/sprite_jogador.png");
    if (!jogador_1)
        return 1;
    ...
    while (1)
    {
        ...
        if (event.type == ALLEGRO_EVENT_TIMER)
        {
            ...
            if (++animation_counter >= ANIMATION_DELAY_JOGADOR)
            {
                jogador_1->frame_atual = (jogador_1->frame_atual + 1) % 72;
                animation_counter = 0;
            }
        ...
        else if (event.type == ALLEGRO_EVENT_KEY_DOWN || event.type == ALLEGRO_EVENT_KEY_UP)
        {
            ...
            {
            case ALLEGRO_KEY_LEFT: joystick_esquerda(jogador_1->controle); break;
            case ALLEGRO_KEY_RIGHT: joystick_direita(jogador_1->controle); break;
            case ALLEGRO_KEY_UP: joystick_cima(jogador_1->controle); break;
            case ALLEGRO_KEY_DOWN: joystick_baixo(jogador_1->controle); break;
            case ALLEGRO_KEY_SPACE: joystick_fogo(jogador_1->controle); break;
            }
        }
